...
var css = function css(ele, styles) {
  for (var key in styles) {
    ele.style[key] = styles[key];
  }
};

var addClass = function addClass(ele, iClass) {
...
var $ = _dom2.default.$,
    ...
    css = _dom2.default.css,
    addClass = _dom2.default.addClass;


var $resumeWrap = $('#app .resume-wrap')[0];
var $resumetag = $('.resume-tag', $resumeWrap)[0];
var $resumeMarkdown = $('.resume-markdown', $resumeWrap)[0];

var currentMarkdown = '';
var length = _resume2.default.length;
var timer = null;
var delay = 60;
var start = 0;
...
var markdownToHtml = function markdownToHtml() {
  return new Promise(function (resolve, reject) {
    css($resumeMarkdown, {
      display: 'none'
    });
    addClass($resumeWrap, iClass);
    html($resumetag, (0, _marked2.default)(_resume2.default));
    resolve();
  });
};
...
var showResume = function showResume() {
  return new Promise(function (resolve, reject) {
    ...
    timer = setInterval(function () {
      currentMarkdown += _resume2.default.substring(start, start + 1);
      if (currentMarkdown.length === _resume2.default.length) {
        clearInterval(timer);
        resolve();
      } else {
...
var _prismjs = __webpack_require__(9);
...
var showStyles = function showStyles(num) {
  return new Promise(function (resolve, reject) {
    var style = _styles2.default[num];
    var length = void 0;
    ...
    length = _styles2.default.filter(function (item, i) {
      return i <= num;
    ...
    timer = setInterval(function () {
      ...
      if (currentStyle.length === length) {
        ...
        html($stylePre, _prismjs2.default.highlight(currentStyle, _prismjs2.default.languages.css));
      }
    }, delay);
  });
};
...
var _stylesEditor = __webpack_require__(3);

var _stylesEditor2 = _interopRequireDefault(_stylesEditor);

var _resumeEditor = __webpack_require__(2);
...
var showResume = _resumeEditor2.default.showResume,
    markdownToHtml = _resumeEditor2.default.markdownToHtml;


showStyles(0).then(function () {
  return showResume();
}).then(function () {
  return showStyles(1);
}).then(function () {
...
exports.default = resumeMarkdown;
